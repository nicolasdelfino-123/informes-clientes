...
# Periodo: 24/05/2026 al 15/06/2026
...
DATA = {
    ...
    "sesiones": 379,
    "usuarios_activos": 265,
    "usuarios_nuevos": 265,
    "usuarios_recurrentes": 32,
    "vistas_pagina": 1198,
    "eventos_totales": 2583,
    "sesiones_interaccion": 300,
    "porcentaje_interaccion": "79,16%",
    "vistas_por_sesion": "3,16",
    "duracion_media_sesion": "3 min 38 s",

    # Eventos destacados (solo los que suman)
    "vio_producto": 166,
    "selecciono_tamano": 77,
    "agrego_al_carrito": 59,
    ...
    "ciudades": [
        {"ciudad": "Punta Arenas",  "usuarios": 139},
        {"ciudad": "Santiago",      "usuarios": 57},
        {"ciudad": "Puerto Natales","usuarios": 29},
        {"ciudad": "Concepcion",    "usuarios": 13},
    ],

    # Paginas publicas con mas movimiento (sin admin)
    "paginas": [
        {"pagina": "Portada",                      "vistas": 323, "lectura": "La entrada principal del catalogo. El link funciona."},
        {"pagina": "Listado de productos",          "vistas": 227, "lectura": "Las personas avanzan a explorar toda la oferta."},
        {"pagina": "Inicio",                        "vistas": 118, "lectura": "Recorrido fuerte dentro de la estructura del sitio."},
        {"pagina": "Categoria Fragancias Femeninas","vistas": 117, "lectura": "Una de las secciones mas consultadas del periodo."},
        {"pagina": "Categoria Fragancias Masculinas","vistas": 83, "lectura": "Gran interes parejo entre masculino y femenino."},
    ],

    # Textos
    "resumen": (
        "Durante los ultimos 23 dias, el catalogo recibio 265 personas reales "
        "que navegaron, miraron productos, eligieron presentaciones y llegaron hasta el pedido por WhatsApp. "
        "Esas 265 personas generaron 379 visitas en total, lo que significa que muchos volvieron mas de una vez "
    ...
    "destacado": (
        "El 79% de las visitas fueron activas: las personas no solo entraron y salieron, sino que "
        "navegaron, bajaron el scroll, vieron productos y tomaron decisiones dentro del catalogo. "
        "En promedio, cada visita recorrio mas de 3 pantallas y paso casi 4 minutos explorando."
    ),

    "flujo_comercial": (
        "Lo mas valioso del periodo es el recorrido comercial que se registra: 166 veces alguien miro "
        "un producto en detalle, 77 veces eligio la presentacion o tamano, 59 veces agrego un producto "
    ...
    "canales": (
        "La gran mayoria del trafico llego desde redes sociales organicas: 292 sesiones de Instagram y "
        "links compartidos. Otras 83 sesiones llegaron de forma directa, lo que indica clientes que "
...
def build_pdf(data, output_path):
    ...
    GLOSARIO = [
        ...
        ("Busqueda organica\n(Organic Search)",
         ...
         "Es una senal de que la pagina esta ganando presencia en internet."),
    ]
